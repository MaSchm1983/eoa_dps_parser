...
# Window & frame sizes
WINDOW_WIDTH = 400
MIN_HEIGHT = 460  # Increased height by 50
MAX_HEIGHT = 460
TITLE_BAR_HEIGHT = 35
BUTTON_SIZE = 25
FRAME_PADDING = 5
...
COLORS = {
    ...
    'MODE_BTN_BG_DPS':     QColor(255, 100, 100, int(0.4*255)),
    'MODE_BTN_BG_HPS':     QColor(100, 255, 100, int(0.4*255)),
    'MODE_BTN_BG_DTS':     QColor(100, 100, 255, int(0.4*255)),
